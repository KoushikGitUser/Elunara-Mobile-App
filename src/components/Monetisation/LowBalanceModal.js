...
const LowBalanceModal = () => {
  ...
  const handleRecharge = () => {
    dispatch(setToggleLowBalanceModal(false));
  ...
  return (
    <Modal
      visible={toggleStates.toggleLowBalanceModal}
      transparent={true}
      animationType="slide"
      onRequestClose={() => dispatch(setToggleLowBalanceModal(false))}
    >
      <View style={styles.container}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={1}
          onPress={() => dispatch(setToggleLowBalanceModal(false))}
        />
