...
const UnlockMaxUploadLimitPopup = () => {
  ...
  return (
    <Modal
      ...
      transparent={true}
      animationType="slide"
      onRequestClose={() => dispatch(setToggleUnlockMaxUploadLimitPopup(false))}
    >
      <View style={styles.container}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={1}
          onPress={() => dispatch(setToggleUnlockMaxUploadLimitPopup(false))}
        />
        ...
        <View style={styles.modalSheet}>
          ...
          <View style={styles.content}>
            ...
            <Text style={styles.title}>File Uploads Disabled</Text>

            <Text style={styles.description}>
              Your wallet balance is ₹{balance.toLocaleString("en-IN")}, which is below the ₹799 threshold required for file uploads. Recharge your wallet to re-enable file-related features.
            </Text>

            <View style={styles.balanceCard}>
              <Text style={styles.balanceLabel}>Current Balance</Text>
              <Text style={styles.balanceAmount}>₹{balance.toLocaleString("en-IN")}</Text>
              <Text style={styles.balanceNote}>Minimum ₹799 required for file features</Text>
            </View>
