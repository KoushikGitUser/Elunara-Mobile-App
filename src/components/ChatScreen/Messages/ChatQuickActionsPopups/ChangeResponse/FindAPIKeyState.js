import { View, Text, ScrollView, TouchableOpacity, Dimensions, Platform, StyleSheet } from "react-native";
import React, { useState } from "react";
import { ArrowLeft } from "lucide-react-native";
import { AntDesign } from "@expo/vector-icons";
import FindAPIKeyAccordian from "../../../ChatInputCompos/ToolsPopupStates/LLMStates/FindAPIKeyAccordian";
import { useDispatch } from "react-redux";
import { findApiKeyNotices } from "../../../../../data/datas";
import { scaleFont, verticalScale } from "../../../../../utils/responsive";
const screenHeight = Dimensions.get("window").height;

const FindAPIKeyState = ({setCurrentStateOfPopup}) => {
    ...
    <View style={styles.modalSheet}>
      <View style={styles.content}>
        <View style={styles.closeModalMain}>
          <ArrowLeft onPress={() => setCurrentStateOfPopup(4)} size={30} strokeWidth={2} />
          <AntDesign
...
export default FindAPIKeyState;
