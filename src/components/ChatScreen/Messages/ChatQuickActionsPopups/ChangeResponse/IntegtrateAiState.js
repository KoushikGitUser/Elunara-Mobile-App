      ...
      <View style={styles.content}>
        ...
        >
          <View style={styles.noteSection}>
            <Image
              source={verifyIcon}
              style={{ height: 21, width: 20, marginTop: 5,objectFit:"contain" }}
            />
            <Text
              style={{
            ...
            >
              Your API key is used to securely connect your AI account. Keep it
          ...
          <TouchableOpacity
            style={{ marginTop: 10 }}
            onPress={() => setCurrentStateOfPopup(5)}
          >
            <Text
              style={{
...
export default IntegtrateAiState;
